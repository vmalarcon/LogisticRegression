...
input_layer_size  = 4900;  % 140x140 Input Images of Digits
hidden_layer_size = 200;    % 100 hidden units
num_labels = 1;             % 10 labels, from 1 to 10   
                            % (note that we have mapped "0" to label 10)

training_file = '21001_training_xy_bw.mat';
testing_file = '21001_testing_xy_bw.mat';
params_file = '21001_weights_bw.mat';
